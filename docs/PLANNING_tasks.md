...
- [ ] `@bvela` Create GitHub repo, add `CLAUDE.md`, `PLANNING_features.md`, `PLANNING_tasks.md`, `.gitignore`, `LICENSE`.
- [ ] `@bvela` Initialize FastAPI project with Poetry/uv, Pydantic Settings, `/health` endpoint, structured logging.
